...
public class CharacterSelect : MonoBehaviour {
	...
	public GameObject SecretsServer;
	public Text SaltyServerText;
	public Text SecretsServerText;
	...
	public void setupBtn()
	{
		...
		SecretsServer.GetComponent<Button>().onClick.AddListener(delegate { SecretsClicked(param); });
		...
		CEnter.GetComponent<Button>().onClick.AddListener(delegate { Cbtn1Clicked(param); });
	...
	public void LoginButtonClicked(string param)
	{
		...
		if (UserNameInput.text.Length > 0 && PasswordInput.text.Length > 0 && HostNameInput.text.Length > 0) {
			StartCoroutine(WorldConnection.ConnectToWebSocketServer (HostNameInput.text, "aksdjlka23ij3l1j23lk1j23j123jkjql", UserNameInput.text, PasswordInput.text));
		}
		else {
	...
	public void SaltyClicked(string param)
	{
		...
		SecretsServerText.color = Color.black;
		HostNameInput.text = "198.245.55.69:52685";
	}
	
	public void SecretsClicked(string param)
	{
		//		Debug.Log("foo " + param);
		SaltyServerText.color = Color.black;
		SecretsServerText.color = Color.red;
		HostNameInput.text = "68.83.231.103:9080";
	}
